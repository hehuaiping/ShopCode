...
<body>
	...
	<div class="container">
				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr class="warning">
							...
							<c:forEach items="${sessionScope.orders.orderItem }" var="orderItem">
								<tr class="active">
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/OrderServlet" style="margin-top: 5px; margin-left: 150px;">
				<!-- 隐藏标签,要调用method的名字,从表单提交 -->
				<input  type="hidden" name="method" value="confirmOrder" />
				<!-- 获取当前订单ID -->
				<input  type="hidden" name="oid" value="${sessionScope.orders.oid }"  />

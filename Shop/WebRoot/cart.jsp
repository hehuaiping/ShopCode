...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="row">
				<!-- 购物车没有商品 -->
				<c:if test="${empty sessionScope.cart.cartMap}">
					<h3><a href="${pageContext.request.contextPath}/ProductServlet?method=productListByCid&cid=1&thisPage=1">购物车空空的,去选点点商品吧</a></h3>
				</c:if>
				<!-- 购物车有商品 -->
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								...
								<c:forEach items="${sessionScope.cart.cartMap }" var="entry">
								<tr class="active">
									...
									<td width="15%">
										<span class="subtotal">￥${entry.value.totlesum}</span>
									</td>
									<td>
										<a href="${pageContext.request.contextPath}/CartServlet?method=deleteProductById&pid=${entry.value.product.pid}" class="delete">删除</a>
									</td>
									</tr>
								</c:forEach>
				...
				登录后确认是否享有优惠&nbsp;&nbsp;
			</em> 赠送积分: <em style="color:#ff6600;">596</em>&nbsp; 商品金额: <strong style="color:#ff6600;">￥${cart.totleMoney }</strong>
				</div>

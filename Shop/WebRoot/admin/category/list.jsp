							...
							<c:forEach items="${categoryList}" var="category">
								...
								onmouseout="this.style.backgroundColor = '#F5FAFE';">
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%">${i}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${category.cid }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${category.cname }</td>
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/AdminServlet?method=findCategoryByCid&cid=${category.cid}">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/AdminServlet?method=deleteCategoryByCid&cid=${category.cid}">
